...
# В связи с рядом технических сложностей я генерирую аутлук через JS
def send_message_to_telegram_and_mail(user, student, message, subject, text_body, html_body):
